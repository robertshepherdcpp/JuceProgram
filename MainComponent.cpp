...
//==============================================================================
MainComponent::MainComponent() : juce::AudioAppComponent(otherDeviceManager), state(Stopped), openButton("Open"), playButton("Play"), stopButton("Stop"), repeatButton("Repeat")
{
...
{
    //choose a file
    FileChooser chooser("Choose a Wav or AIFF File", File::getSpecialLocation(File::userDesktopDirectory), "*.wav; *.mp3; *.aiff");
...
void MainComponent::repeatButtonClicked()
{
...
void MainComponent::resized()
{
    ...
    repeatButton.setBounds(10, 130, getWidth() - 20, 30);
